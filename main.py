...
from markdown_translator.md_translator import MarkdownTranslator
...
if __name__ == "__main__":
    # NOTE: idx=0はスクリプトファイル名になってしまう.
    # NOTE: 動作確認の場合は、sample_markdown.mdを指定する.
    input_md_path_str = sys.argv[1]
    # input_md_path_str = "sample_markdown.md"
