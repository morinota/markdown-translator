...
from utils.driver_utils import click, pass_forms, try_find_element_click, try_find_element_send_keys
...
class GummyAbstGateWay(metaclass=ABCMeta):
    ...
    def passthrough(self, driver, url=None, journal_type=None, **gatewaykwargs):
        ...
        * Call a function with keyword argument:
        ...
        if self.verbose:
            print(f"Use {toGREEN(self.class_name)}.{toBLUE(pass2journal.__name__)} method.")
